...
export default function HomePage() {
  ...
  const testimonials = [
    { name: 'Fatima Rahman', text: 'Beautiful jewelry! The quality exceeded my expectations.', rating: 5 },
    { name: 'Nusrat Jahan', text: 'Fast delivery and the saree was exactly as shown. Love it!', rating: 5 },
    { name: 'Ayesha Begum', text: 'Great customer service. Will definitely order again.', rating: 5 },
  ];
          ...
          <div className="py-16 md:py-24 lg:py-32 max-w-2xl">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-4 text-balance">
                Discover Unique Artisan Crafts
              </h1>
              <p className="text-lg md:text-xl text-primary-foreground/90 mb-8 max-w-lg">
                Explore our collection of handmade jewelry, home decor, and traditional clothing from Bangladesh's finest artisans.
              </p>
